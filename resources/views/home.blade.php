...
@section('title')
    Kelurahan langgini Bangkinang Kota
@endsection
                            ...
                            <div class="card__post card__post-list">
                                <div class="image-sm">
                                    <a href="./card-article-detail-v1.html">
                                        <img src="/news/images/placeholder/500x400.jpg" class="img-fluid" alt="">
                                    </a>
                                </div>
                        ...
                        <div class="card__post-carousel">
                            <div class="item">
                                ...
                                <div class="card__post">
                                    <div class="card__post__body">
                                        <a href="./card-article-detail-v1.html">
                                            <img src="/news/images/placeholder/800x600.jpg" class="img-fluid" alt="">
                                        </a>
                            ...
                            <!-- Post Article -->
                                <div class="card__post ">
                                    <div class="card__post__body card__post__transition">
                                        <a href="./card-article-detail-v1.html">
                                            <img src="/news/images/placeholder/600x400.jpg" class="img-fluid" alt="">
                                        </a>
                                        <div class="card__post__content bg__post-cover">
                                            <div class="card__post__category">
                                                politics
                            ...
                            <div class="item">
                                ...
                                <div class="article__entry">
                                    <div class="article__image">
                                        <a href="#">
                                            <img src="/news/images/placeholder/500x400.jpg" alt="" class="img-fluid">
                                        </a>
                                    </div>
